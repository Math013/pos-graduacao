...
library(stats)
dados <- readxl::read_excel("C:/Users/Matheus/Desktop/Arquivos_PUC/Modelos de Regressão/Dados/dados_exemplo_multinomial.xlsx")
dados
```
...
Variedadec : A variedade B tem 3 x mais chance de crescer que a
Variedade A

VariedadeD : A variedade B tem 23 x mais chance de crescer que a
Variedade A

VariedadeE : A variedade B tem 0.48 menos chance de crescer que a
Variedade A

dose:variedade B Proporção que eu tenho de aumento na chance da variavel
B aumentar , quando temos o acrescimo de 1 undiade de dose em comparação
a variedade A
